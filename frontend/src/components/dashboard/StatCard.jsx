...
const StatCard = ({ title, value, change, icon: Icon, trend }) => {
  ...
  return (
    <div className="group rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-3xl transition-all duration-300 hover:-translate-y-2 hover:border-cyan-400/30 hover:shadow-[0_20px_60px_rgba(6,182,212,0.15)]">

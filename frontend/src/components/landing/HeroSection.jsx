...
const HeroSection = () => {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="mx-auto flex min-h-screen max-w-7xl items-center px-6 pt-32 pb-24 lg:px-8">
        <div className="grid w-full items-center gap-20 lg:grid-cols-[1fr_1.1fr]">
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-12 flex flex-col gap-4 sm:flex-row">
              ...
              <Link to="/login">
                <Button
                  variant="outline"
                  className="w-full border-white/15 bg-white/5 text-white backdrop-blur-xl hover:bg-white/10 sm:w-auto"
                >
                  Sign In
                </Button>
              </Link>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-3xl">
              <div className="absolute inset-0 rounded-[2.75rem] bg-gradient-to-r from-cyan-500/20 via-sky-500/10 to-violet-500/20 blur-3xl" />

              <div className="relative rounded-[2.75rem] border border-white/10 bg-white/10 p-8 shadow-[0_35px_80px_rgba(0,0,0,0.5)] backdrop-blur-3xl lg:p-10">
                {/* Dashboard Header */}
                ...
                {/* Floating Cards */}
                <div className="absolute -right-8 -top-8 hidden rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur-2xl xl:block">
                ...
                <div className="absolute -bottom-8 -left-8 hidden rounded-2xl border border-white/10 bg-white/10 p-5 backdrop-blur-2xl xl:block">
                  <p className="text-xs text-slate-400">
                    AI Accuracy
                  </p>
                  <h4 className="mt-2 text-3xl font-black text-white">
